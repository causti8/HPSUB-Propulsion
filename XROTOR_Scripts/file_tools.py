    ...
    def __init__(self, file_name):
        ...
        with open(file_name, 'r') as f:
            for i, line in enumerate(f):
                ...
                if 'thrust' in line:
                    self.thrust, self.power, self.torque = remove_words(line)
                if 'Efficiency' in line:
                    self.efficiency, self.vel, self.rpm = remove_words(line)
                if 'Eff ideal' in line:
                    _, self.efficiency_ideal, _ = remove_words(line)
